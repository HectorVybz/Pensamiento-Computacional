...
def agregar_productos(cantidad):
    productos = []  #La lista bidimensional para almacenar productos
    for i in range(cantidad):
        ...
        productos.append([producto, precio, cantidad_producto])  #Fila con nombre, precio, cantidad
    return productos
...
def eliminar_producto(productos):
    ...
    for producto in productos:
        if producto_a_eliminar == producto[0]:
